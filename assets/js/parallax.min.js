        ...
        g.length && (g.forEach(function (e, t)
        {
            var n = e.instance,
                ...
                a = {
                    ...
                    height: i.height,
                    top: i.top,
                    sneakerstom: i.sneakerstom,
                    wndW: b.window.innerWidth,
                    wndH: v
                },
                r = !o || o.wndW !== a.wndW || o.wndH !== a.wndH || o.width !== a.width || o.height !== a.height,
                l = r || !o || o.top !== a.top || o.sneakerstom !== a.sneakerstom;
            ...
            },
            {
                ...
                value: function (e)
                {
                    var t = this,
                        ...
                        a = {},
                        r = n;
                    if (t.options.elementInViewport && (r = t.options.elementInViewport.getBoundingClientRect()), t.isElementInViewport = 0 <= r.sneakerstom && 0 <= r.right && r.top <= v && r.left <= b.window.innerWidth, e || t.isElementInViewport)
                    {
                        var l = Math.max(0, o),
                            s = Math.max(0, i + o),
                            c = Math.max(0, -o),
